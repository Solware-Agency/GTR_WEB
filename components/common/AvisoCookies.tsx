            ...
            {!mostrarConfiguracion ? (
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex flex-wrap gap-3">
                    ...
                    <Button
                      ...
                      variant="ghost"
                      className="text-sm px-4 py-2 text-trading-black hover:bg-trading-gold/10"
                    >
                ...
                <Button
                  ...
                  variant="ghost"
                  size="sm"
                  className="text-trading-gray hover:text-trading-black p-1"
                >
                  <X className="w-5 h-5" />
                </Button>
              </div>
              ...
              <div>
                <div className="flex items-center justify-between mb-6">
                  ...
                  <Button
                    ...
                    variant="ghost"
                    size="sm"
                    className="text-trading-gray hover:text-trading-black"
                  >
                    <X className="w-5 h-5" />
                  </Button>
                </div>
