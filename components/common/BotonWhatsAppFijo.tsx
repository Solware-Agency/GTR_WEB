...
export default function BotonWhatsAppFijo() {
  ...
  const mensajePredefinido = `¡Hola Danny! Me interesa conocer más sobre el Global Trading Room y cómo puedo unirme a las sesiones diarias de trading. ¿Podrías darme más información sobre el proceso de validación y acceso a AlphaCopilot?`;

  const abrirWhatsApp = () => {
    const numeroWhatsApp = '584242866986';
    const url = `https://wa.me/${numeroWhatsApp}?text=${encodeURIComponent(mensajePredefinido)}`;
